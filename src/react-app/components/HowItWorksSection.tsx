      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Simples, rápido e <span className="text-inova-gold">100% online</span>
          </h2>
        </div>
            ...
            return (
              <div key={index} className="text-center group">
                <div className="relative mb-6">
                  ...
                  {/* Ícone */}
                  <div className="w-20 h-20 bg-inova-gold rounded-full flex items-center justify-center mx-auto group-hover:bg-dark-gold transition-colors shadow-lg">
        ...
        <div className="text-center">
          <a
            ...
            className="inline-block bg-inova-gold hover:bg-dark-gold text-white px-8 py-4 rounded-lg text-lg font-semibold transition-all duration-300 transform hover:scale-105 shadow-lg"
          >
