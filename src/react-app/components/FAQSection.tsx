...
export default function FAQSection() {
  ...
  const faqs = [
    {
      question: "O que é o crédito com garantia de veículo?",
      answer: "O crédito com garantia de veículo é uma modalidade de crédito na qual o veículo fica como garantia para o banco até a quitação do contrato. Dentre os diversos benefícios, o que mais chama atenção é que o valor é depositado diretamente na conta do cliente, podendo ser utilizado para qualquer finalidade, e o prazo para pagamento pode ser estendido em até 48 parcelas."
    },
    {
      question: "Meu veículo não está quitado, é possível fazer o crédito com garantia de veículo?",
      answer: "Sim, você deve adicionar o valor da quitação do carro ao montante do crédito."
    },
    {
    ...
    {
      question: "O veículo precisa estar em meu nome no momento da contratação do crédito com garantia de veículo?",
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Dúvidas frequentes sobre <span className="text-inova-gold">crédito com garantia de veículo</span>
          </h2>
        </div>
        ...
        <div className="space-y-4">
          {faqs.map((faq, index) => {
            ...
            return (
              <div key={index} className="bg-white rounded-xl border border-gray-200 overflow-hidden hover:border-inova-gold/30 transition-colors">
                <button
                ...
                >
                  ...
                  {isOpen ? (
                    <ChevronUp className="w-5 h-5 text-inova-gold flex-shrink-0" />
                  ) : (
