      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            Quais tipos de veículos posso usar como <span className="text-inova-gold">garantia</span>?
          </h2>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {vehicleTypes.map((vehicle, index) => (
            <div key={index} className="bg-white rounded-xl p-8 text-center hover:shadow-lg transition-shadow group border border-inova-gold/20">
        ...
        <div className="bg-inova-gold rounded-2xl p-8 lg:p-12 text-white text-center">
          <h3 className="text-2xl lg:text-3xl font-bold mb-6">
            Importante saber
          </h3>
          <div className="max-w-4xl mx-auto space-y-4 text-lg">
            <p>
              <strong>Oferecemos crédito e refinanciamos</strong> veículos quitados ou financiados.
            </p>
            <p>
